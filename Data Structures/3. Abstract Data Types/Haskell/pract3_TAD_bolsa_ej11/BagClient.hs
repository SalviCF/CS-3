...
{-
Un saco (o multiconjunto) es parecido a un conjunto salvo que un elemento
puede estar incluido varias veces.
-}
...
contains x = foldBag (\e oe b -> e==x || b) False   --recibe elemento, ocurrencias y booleano
...
maxOcurrences = foldBag (\e oe m -> max oe m) 0
