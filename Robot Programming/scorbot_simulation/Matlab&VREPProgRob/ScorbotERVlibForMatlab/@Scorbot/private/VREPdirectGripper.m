function [uTg,posetip]=VREPdirectGripper(scbconsts,Q,theta1,pitch,roll)
% Given yaw (theta1), pitch and roll in radians and as defined for the 
% gripper of the
...
% calculated for the orientation of the gripper in the universal frame
    ...
    v=p(1:3)-Q; % vector pointing as the gripper
