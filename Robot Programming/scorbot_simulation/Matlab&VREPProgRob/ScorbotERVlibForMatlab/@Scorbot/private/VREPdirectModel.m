function [uTs,Q,uTg,posetip]=VREPdirectModel(scbconsts,thetas,pitch,roll)
...
% univ. frame
     ...
     [uTs,Q]=VREPdirectArm(scbconsts,thetas);
     [uTg,posetip]=VREPdirectGripper(scbconsts,Q,thetas(1),pitch,roll);
