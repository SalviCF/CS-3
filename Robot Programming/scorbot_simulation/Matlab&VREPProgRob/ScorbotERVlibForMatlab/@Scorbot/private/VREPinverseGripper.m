function solutions=VREPinverseGripper(scbconsts,posetip)
...
% 2), each one being a struct with fields theta1,pitch,roll,Q.
    ...
    [thetas,p,r,gripper]=VREProbotHome(scbconsts); % just to obtain some values of theta2 and theta3 within range
